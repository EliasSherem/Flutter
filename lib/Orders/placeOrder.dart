...
class PaymentPage extends StatefulWidget {
  ...
  PaymentPage({required this.addressId,required this.totalAmount});
  @override
...
class _PaymentPageState extends State<PaymentPage> {
  ...
  emptyCartNow(){
    ...
    Firestore.instance.collection("users")
        .document(EcommerceApp.sharedPreferences.getString(EcommerceApp.userUID)).updateData({
      EcommerceApp.userCartList: tempList,
    }).then((value){
      EcommerceApp.sharedPreferences.setStringList(EcommerceApp.userCartList, tempList!);
      Provider.of<CartItemCounter>(context,listen: false).displayResult();
    });
    Fluttertoast.showToast(msg: "Congratulations, your order has been placed succesfully");
