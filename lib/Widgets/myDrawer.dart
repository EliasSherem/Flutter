...
import 'package:fume/Address/addAddress.dart';
import 'package:fume/Store/Search.dart';
import 'package:fume/Store/cart.dart';
import 'package:fume/Orders/myOrders.dart';
        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                Material(
                  borderRadius: BorderRadiusDirectional.all(Radius.circular(80.0)),
                  elevation: 8.0,
                  child: Container(
                    height: 160.0,
                    width: 160.0,
