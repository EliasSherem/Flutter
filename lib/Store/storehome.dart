...
import 'package:fume/Store/product_page.dart';
                ...
                Positioned(
                  ...
                  child: Consumer<CartItemCounter>(
                    builder: (context,counter, _){
                      return Text(
                        (EcommerceApp.sharedPreferences.getString(EcommerceApp.userCartList)!.length-1).toString(),
                ...
                return !dataSnapshot.hasData
                    ...
                    : SliverStaggeredGrid.countBuilder(
                        ...
                        itemBuilder: (context, index){
                          ...
                          return sourceInfo(model, context, background: Colors.white);
                        },
                  ...
                  Align(
                    ...
                    child: removeCartFunction == null
                      ...
                      onPressed: (){
                        ...
                        : IconButton(
                            icon: Icon(Icons.remove_shopping_cart,color: Colors.blueAccent,),
                            onPressed: (){
                              removeCartFunction();
...
addItemToCart(String productID,BuildContext context){
  List<String> tempCartList = EcommerceApp.sharedPreferences.getStringList(EcommerceApp.userCartList)!;
